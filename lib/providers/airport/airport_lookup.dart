...
final Provider<Map<String, Airport>> airportIndexProvider =
    Provider<Map<String, Airport>>((ProviderRef<Map<String, Airport>> ref) {
      final List<Airport> list = ref
          .watch(airportDataProvider)
          .maybeWhen(
            data: (List<Airport> v) => v,
            orElse: () => const <Airport>[],
          );
...
final ProviderFamily<Airport?, String> airportByIataProvider =
    Provider.family<Airport?, String>((ProviderRef<Airport?> ref, String code) {
...
final ProviderFamily<String?, String> cityByIataProvider =
    Provider.family<String?, String>((ProviderRef<String?> ref, String code) {
