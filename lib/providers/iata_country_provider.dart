...
final FutureProvider<Map<String, String>> iataCountryResolverProvider =
...
final FutureProviderFamily<PricingMode, (String, String)>
roundTripModeProvider = FutureProvider.family<PricingMode, (String, String)>((
  FutureProviderRef<PricingMode> ref,
  (String, String) pair,
) async {
  ...
  final String originCountry = (iataToCountry[originIata.toUpperCase()] ?? "");
